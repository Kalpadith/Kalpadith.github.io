...
import 'hairStyleList.dart';

class AddHairStyle extends StatefulWidget {
  static const String routeName = '/addHairStyle';
...
class _AddHairStyleState extends State<AddHairStyle> {
  ...
  postData() async {
    if (image != null) {
      ...
      print("objec             ddddddddddddddddddddddddt");
  ...
  _CreatHairStyle() async {
    try {
      var response = await http
          .post(Uri.parse('http://localhost:5000/hairstyle/create'), body: {
        'name': _name,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            Positioned.fill(
              child: Image.asset("../assets/images/treatmentCover.jpg",
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: "Name of the Hair Style",
                                      labelStyle:
                                    ...
                                    validator: (value) {
                                      if (value == null || value.isEmpty) {
                                        return "Please enter the hair style name";
                                      }
                                      return null;
                                    },
                                    onChanged: (text) {
                              ...
                              Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                      onPrimary:
                                          Color.fromARGB(255, 249, 237, 237),
