...
class UpdateTreatment extends StatefulWidget {
  ...
  static const String routeName = '/updatetreatment';

  const UpdateTreatment({Key? key, required this.treatment}) : super(key: key);
  @override
...
class _UpdateTreatmentState extends State<UpdateTreatment> {
  ...
  updateData() async {
    ...
    if (_pickedImage == null) {
      _UpdateTreatment(widget.treatment?.image);
    } else {
      _uploadImage().then((value) {
        _UpdateTreatment(value);
      });
    }
  }

  _UpdateTreatment(String? _imageURL) async {
    _name ??= widget.treatment?.name;
    _description ??= widget.treatment?.desc;
    try {
      var response = await http.put(
          Uri.parse(
              'http://localhost:5000/treatment/update/${widget.treatment?.id}'),
          body: {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    initialValue: widget.treatment?.name,
                                    onChanged: (text) {
                                      setState(() {
                                        _name = text;
                                      });
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    maxLines: null,
                                    initialValue: widget.treatment?.desc,
